...
export default class ApiService {
  ...
  static async getAllOpportunitiesByCity(city) {
    const response = await axios.get(
      `${this.BASE_URL}/api/opportunity/${city}`,
      {}
    );
    return response.data;
  }
  ...
  static async getUserEnrollment(userId) {
    const response = await axios.get(
      `${this.BASE_URL}/api/user/enroll/${userId}`,
      {},
      {}
    );
    return response.data;
